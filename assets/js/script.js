...
/**
 * Gets the operands (numbers) and the operator (plus,minus sign etc)
...
/**
 * gets the current score from the DOM nad increments it by 1
 */
...
/**
 * gets the current tally of incorrect answers and updates it by 1
 */
